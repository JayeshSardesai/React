...
const page = () => {
    ...
    return (
        <div className='text-white containor py-14 mx-auto'>
            <h1 className='text-center font-bold text-3xl'>Login/SignUp to Get your fans to support you</h1>
            <div className="social-login-buttons flex justify-center items-center mt-10">
                <div className="flex flex-col gap-5 min-h-screen p-10">
                    <button
                        className="flex items-center text-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    ...
                    <button
                        onClick={() => signIn("github")} className="flex items-center text-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
