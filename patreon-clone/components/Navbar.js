    ...
    return (
        <nav className='bg-gray-900 text-white flex justify-between items-center p-4'>
            <Link href={"/"} className='flex justify-center items-center'>
                <div className='logo text-2xl font-bold flex justify-center items-center'>FundLELE</div>
            </Link>
            <div className='flex justify-center items-center'>
                {session && <>
                    ...
                    <div
                        id="dropdown"
                        ref={dropdownRef}
                        className={`z-10 ${showdropdown ? "block" : "hidden"} bg-white divide-y absolute top-15 right-60 divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700`}
                    >
